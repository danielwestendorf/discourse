...
ssh_options[:keys] = ["/Users/dwestendorf/.ssh/aws-discourse.pem"]

# Repository settings, forked to an outside copy
set :repository, 'git@github.com:danielwestendorf/discourse.git'
...
role :app, 'ec2-107-20-115-48.compute-1.amazonaws.com', primary: true
role :db,  'ec2-107-20-115-48.compute-1.amazonaws.com', primary: true
role :web, 'ec2-107-20-115-48.compute-1.amazonaws.com', primary: true
...
namespace :db do
  ...
  task :seed do
    run "cd #{current_path} && psql -d discourse_prod < pg_dumps/production-image.sql"
  end
end
